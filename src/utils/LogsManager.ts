...
export class LogsManager {
    ...
    public static async logTicketTranscript(
        ...
        try {
            ...
            const transcriptLogsChannel = (await client.channels.fetch(transcriptLogsChannelId)) as TextChannel;
    ...
    private static async logTicketAction(
        ...
        try {
            ...
            if (title === '📝 Transcript Generated' || (title === '⛔ Ticket Closed' && enableTranscripts)) {
                const targetChannel = title === '📝 Transcript Generated' ? transcriptLogsChannelId : logChannelId;
