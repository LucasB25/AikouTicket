...
export class LogsManager {
    ...
    private static async getLogChannel(client: Bot): Promise<TextChannel> {
        ...
        const logChannel = await LogsManager.getChannelById(client, logChannelId);
        if (!logChannel) {
    ...
    private static async getChannelById(client: Bot, channelId: string): Promise<TextChannel | null> {
