...
export class LogsManager {
    ...
    private static async logTicketAction(
        ...
        try {
            ...
            if (title === '📝 Transcript Generated' || (title === '⛔ Ticket Closed' && config.enableTranscripts)) {
                const targetChannel = title === '📝 Transcript Generated' ? config.transcriptLogsChannelId : config.logChannelId;
